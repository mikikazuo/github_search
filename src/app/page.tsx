...
export const metadata: Metadata = {
    ...
    description: "GitHub APIを使用してリポジトリを検索・閲覧できるアプリケーション",
};
    ...
    try {
        ...
        return (
            <main className="container mx-auto py-8 px-4">
                <h1 className="text-3xl font-bold mb-8 text-center">GitHub リポジトリ検索</h1>
            ...
            <div className="mt-8">
                ...
                {initialData.items.length > 0 ? (
                    ...
                    <div className="text-center p-8 bg-muted rounded-lg">
                        <p>リポジトリが見つかりませんでした。検索条件を変更してお試しください。</p>
                    </div>
                )}
